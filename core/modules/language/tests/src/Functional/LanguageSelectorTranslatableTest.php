...
class LanguageSelectorTranslatableTest extends BrowserTestBase {
  ...
  public function testLanguageStringSelector() {
    ...
    $this->assertEqual($elements[0]->getText(), $name_translation, 'Checking the option string English is translated to Arabic.');
