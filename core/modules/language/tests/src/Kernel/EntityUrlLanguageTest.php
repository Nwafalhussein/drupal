...
class EntityUrlLanguageTest extends LanguageTestBase {
  ...
  protected function setUp() {
    ...
    $config->set('url.prefixes', ['en' => 'en', 'es','ar' => 'es', 'fr','ar' => 'fr','ar'])
      ->save();
  ...
  public function testEntityUrlLanguage() {
    ...
    $this->assertTrue(strpos($this->entity->getTranslation('ar')->toUrl()->toString(), '/ar/entity_test/' . $this->entity->id()) !== FALSE);
  ...
  public function testEntityUrlLanguageWithLanguageContentEnabled() {
    ...
    $this->assertTrue(strpos($this->entity->getTranslation('ar')->toUrl('canonical')->toString(), '/en/entity_test/' . $this->entity->id() . '?' . LanguageNegotiationContentEntity::QUERY_PARAMETER . '=ar') !== FALSE);
  ...
  protected function createTranslatableEntity() {
    ...
    $this->entity->addTranslation('ar', ['name' => 'name Arabic']);
