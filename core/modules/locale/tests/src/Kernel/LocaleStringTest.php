...
class LocaleStringTest extends KernelTestBase {
  ...
  public function testStringSearchApi() {
    ...
    $translations = $this->storage->getTranslations(['language' => 'ar', 'customized' => LOCALE_CUSTOMIZED, 'translated' => TRUE]);
    $this->assertCount(1, $translations);
    ...
    $filter_options['filters'] = ['source' => $prefix];
    $translations = $this->storage->getTranslations(['language' => 'ar'], $filter_options);
    $this->assertCount(2, $translations);
  }
